...
export function EntrevistaLlamadaPdf({ aplicacion, entrevista, referencias, jefeInmediato }: EntrevistaLlamadaPdfProps) {
                ...
                <View style={styles.table}>
                    ...
                    <View style={styles.tableRow}>
                        ...
                        <View style={[styles.cellLast, { width: '75%' }]}>
                            ...
                            <Text>{jefeInmediato || 'No especificado'}</Text>
                ...
                <View style={styles.table}>
                    ...
                    <View style={styles.tableRow}>
                        ...
                        <View style={[styles.cell, styles.headerLabel, { width: '40%' }]}>
                            ...
                            <Text>DISPONIBILIDAD INMEDIATA,  ACTUALMENTE ESTA LABORANDO O TIENE ALGUNA OCUPACION</Text>
                    ...
                    <View style={styles.tableRow}>
                        ...
                        <View style={[styles.cell, styles.headerLabel, { width: '40%' }]}>
                            ...
                            <Text>RESIDENCIA, DONDE VIVE ACTUALMENTE?</Text>
                    ...
                    <View style={styles.tableRow}>
                        ...
                        <View style={[styles.cell, styles.headerLabel, { width: '40%' }]}>
                            ...
                            <Text>DISPONIBILIDAD DE VIAJAR, EN CASO APLIQUE</Text>
                    ...
                    <View style={styles.tableRowLast}>
                        ...
                        <View style={[styles.cell, styles.headerLabel, { width: '40%' }]}>
                            ...
                            <Text>SOLICITAR REFERENCIAS</Text>
                ...
                <View style={styles.table}>
                    ...
                    <View style={[styles.tableRow, { backgroundColor: '#e0e0e0' }]}>
                        ...
                        <View style={[styles.cell, { width: '18%' }]}>
                            <Text style={[styles.textBold, styles.textCenter]}>APELLIDOS Y NOMBRES</Text>
                        </View>
                        ...
                        <View style={[styles.cell, { width: '15%' }]}>
                            <Text style={[styles.textBold, styles.textCenter]}>TELF.</Text>
                        </View>

                        <View style={[styles.cell, { width: '24%' }]}>
                            <Text style={[styles.textBold, styles.textCenter]}>DETALLE</Text>
                        </View>

                        <View style={[styles.cellLast, { width: '25%' }]}>
                            <Text style={[styles.textBold, styles.textCenter]}>COMENTARIO</Text>
                        </View>

                    </View>

                    {/* Filas de referencias */}
                    {referencias && referencias.length > 0 ? referencias.map((referencia, index) => (

                        <View key={referencia.id} style={[styles.tableRow, index === referencias.length - 1 ? styles.tableRowLast : {}, { minHeight: 25 }]}>

                            <View style={[styles.cell, { width: '18%' }]}>
                                <Text>{referencia.nombresyapellidos}</Text>
                            </View>

                            <View style={[styles.cell, { width: '18%' }]}>
                                <Text>{referencia.empresa || ''}</Text>
                            </View>

                            <View style={[styles.cell, { width: '15%' }]}>
                                <Text>{referencia.numero_telefono}</Text>
                            </View>

                            <View style={[styles.cell, { width: '24%' }]}>
                                <Text>{referencia.detalles || ''}</Text>
                            </View>

                            <View style={[styles.cellLast, { width: '25%' }]}>
                                <Text>{referencia.comentarios || ''}</Text>
                            </View>
                        ...
                        <View style={[styles.tableRowLast, { minHeight: 25 }]}>
